...
Customer: 
    R decision tree algorithm: invoice_cycle_time_decision_tree_auto.R
    Save file as "cycle_time_ML_##.tsv"
...
, GREATEST(0, 
    GREATEST(a.last_approval_date, NVL(h.hold_ovlp_hold_release_date, TO_DATE('1/1/1900', 'MM/DD/YYYY'))) - LEAST(a.validation_date, NVL(h.hold_ovlp_first_hold_date, SYSDATE)) 
...
AND i.invoice_date >= to_date('JAN-01-2016','MON-DD-YYYY')
